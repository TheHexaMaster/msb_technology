...
@dataclass
class Hf5000rModbusButtonEntityDescription(BaseModbusButtonEntityDescription):
    allowedtypes: int = ALLDEFAULT # maybe 0x0000 (nothing) is a better default choice

@dataclass
class Hf5000rModbusNumberEntityDescription(BaseModbusNumberEntityDescription):
    allowedtypes: int = ALLDEFAULT # maybe 0x0000 (nothing) is a better default choice

@dataclass
class Hf5000rModbusSelectEntityDescription(BaseModbusSelectEntityDescription):
    allowedtypes: int = ALLDEFAULT # maybe 0x0000 (nothing) is a better default choice

@dataclass
class Hf5000rModbusSensorEntityDescription(BaseModbusSensorEntityDescription):
    """A class that describes Hf5000r Modbus sensor entities."""
    allowedtypes: int = ALLDEFAULT # maybe 0x0000 (nothing) is a better default choice
...
BUTTON_TYPES = [
    ...
    Hf5000rModbusButtonEntityDescription(
        name = "AC-OUT Turn ON",
        key = "ac_out_on",
        register = 0,
        command = 0,
...
NUMBER_TYPES = [
    ...
    Hf5000rModbusNumberEntityDescription(
...
SELECT_TYPES = [
    ...
    Hf5000rModbusSelectEntityDescription(
...
SENSOR_TYPES: list[Hf5000rModbusSensorEntityDescription] = [
    Hf5000rModbusSensorEntityDescription(
...
@dataclass
class hf5000r_plugin(plugin_base):
