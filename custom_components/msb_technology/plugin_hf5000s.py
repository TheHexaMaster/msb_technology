...
@dataclass
class Hf5000sModbusButtonEntityDescription(BaseModbusButtonEntityDescription):
    allowedtypes: int = ALLDEFAULT # maybe 0x0000 (nothing) is a better default choice

@dataclass
class Hf5000sModbusNumberEntityDescription(BaseModbusNumberEntityDescription):
    allowedtypes: int = ALLDEFAULT # maybe 0x0000 (nothing) is a better default choice

@dataclass
class Hf5000sModbusSelectEntityDescription(BaseModbusSelectEntityDescription):
    allowedtypes: int = ALLDEFAULT # maybe 0x0000 (nothing) is a better default choice

@dataclass
class Hf5000sModbusSensorEntityDescription(BaseModbusSensorEntityDescription):
    """A class that describes Hf5000s Modbus sensor entities."""
    allowedtypes: int = ALLDEFAULT # maybe 0x0000 (nothing) is a better default choice
...
NUMBER_TYPES = [
    ...
    Hf5000sModbusNumberEntityDescription(
...
SELECT_TYPES = [
    ...
    Hf5000sModbusSelectEntityDescription(
...
SENSOR_TYPES: list[Hf5000sModbusSensorEntityDescription] = [
...
@dataclass
class hf5000s_plugin(plugin_base):
...
plugin_instance = hf5000s_plugin(
    plugin_name = 'hf5000s', 
