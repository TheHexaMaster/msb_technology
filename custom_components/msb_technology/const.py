...
CONF_READ_PRM    = "read_prm"
CONF_READ_SCN    = "read_scn"
CONF_READ_PRT    = "read_prt"
...
def value_function_pv_calculated_power(initval, descr, datadict):
    return  datadict.get('mppt_power_1', 0) + datadict.get('mppt_power_2',0)

def value_function_pv_calculated_current(initval, descr, datadict):
    return  datadict.get('mppt_current_1', 0) + datadict.get('mppt_current_2',0)
